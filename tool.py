...
import subprocess  # Import subprocess to run delete.py

UPLOAD_FOLDER = 'static/cipher'
...
if __name__ == "__main__":
    # Start delete.py when the Flask app starts
    subprocess.Popen([sys.executable, 'deletesec.py'])
